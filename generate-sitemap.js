...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var smStream, routes, sitemap;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                smStream = new sitemap_1.SitemapStream({ hostname: 'https://eletronx.com' });
                routes = [
                    '/',
                    '/home',
                    '/servicos',
                ...
                routes.forEach(function (route) { return smStream.write({ url: route, changefreq: 'weekly', priority: 0.8 }); });
                smStream.end();
